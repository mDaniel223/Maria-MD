...
//contact details
global.ownernumber = [ process.env.OWNER_NUMBER || "60103239145"],
global.ownername = process.env.OWNER_NAME || "MR.COLUGO",
global.ytname = "None Profile"
global.socialm = "GitHub: mDaniel223"
global.location = "MALAYSIA"

global.botname = process.env.BOTNAME || "COLUGO",//name of the bot

//sticker details
global.stickername = process.env.STICKER || "COLUGO",
global.packname = 'Sticker By MR.COLUGO aka 41EX'
global.author = process.env.AUTHOR || "MDBOT",
//console view/theme
global.themeemoji = ''
